INSERT INTO USERA (ID, DATE_OF_BIRTH, EMAIL_ADDRESS, FIRST_NAME, LAST_NAME, PASSWORD, PHONE_NUMBER, ROLE, USERNAME) VALUES
	...
	('2', '04-12-2016', 'kl@gmail.com', 'k', 'l', '123', '948384', 'member', 'kl9');
...
INSERT INTO WORKOUT (ID, NAME , DESCRIPTION , TYPE_OF_WORKOUT , WORKOUT_DURATION , COACH_ID ) VALUES
	('2','Chest workout', 'One hour of chest workout', 'group workout', '60', '1'),
	('3','Leg day', 'short workout but strong', 'personal workout', '35', '1');
